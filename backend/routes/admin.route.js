...
import { addAdmin, adminLogin, adminLogout, changeCategoryStatus, changeUserRole, changeUserStatus, getAllPendingProviderRequests } from "../controllers/admin.controller.js";
...
adminRouter.put("/service-provider-status/:requestId", verifyToken, isAdmin, changeUserRole);
